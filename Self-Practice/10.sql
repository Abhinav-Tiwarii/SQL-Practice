...
*/
--Sql Query--
select distinct at.user_id from amazon_transactions at join amazon_transactions ats 
on at.user_id = ats.user_id
where date(ats.created_at) - date(at.CREATED_AT) <= 7 
and at.created_at < ats.created_at;
