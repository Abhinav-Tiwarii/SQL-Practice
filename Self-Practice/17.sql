...
CREATE TABLE my_uber_drives (start_date DATETIME, end_date DATETIME, category VARCHAR(50), start VARCHAR(50),
stop VARCHAR(50), miles FLOAT, purpose VARCHAR(50));
...
-- My Solution --
select purpose, sum(miles) as mileage 
from my_uber_drives 
